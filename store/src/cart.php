...
?>
    ...
    <header class="items-center bg-zinc-950 md:px">
                ...
                <nav class="flex justify-between w-screen">
				   ...
				   " src="./images/logowhite.png" alt="logo" />
                        ...
                        <ul class="hidden md:flex mx-auto space-x-12 text-l text-white">
                            ...
                            <li><a class="hover:text-gray-300" href="apparel.html">Apparel
                                    <svg aria-hidden="true" class="w-5 inline-block origin-center rotate-90"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="icon icon-arrow-right">
                                        <path d="m9 18 6-6-6-6" />
                            ...
                            <li><a class="hover:text-gray-300" href="accessories.html">Accessories
                                    <svg aria-hidden="true" class="w-5 inline-block origin-center rotate-90"
                                        viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                        stroke-linecap="round" stroke-linejoin="round" class="icon icon-arrow-right">
                                        <path d="m9 18 6-6-6-6" />
                    ...
                    <div class="content">
                        <div class="row">
                                                ...
                                                <div class="info">
                                                    <div class="row">
                                                        <div class="col-md-5 product-name">
                                                            <div class="product-name">
                                                                ...
                                                                <div class="product-info">
                                                                    <div>Size: <span
                                                                            class="value"><?php echo $item['size']; ?></span>
                                                                    </div>
                                                                    <input type="hidden"
                                                                        name="size_<?php echo $index; ?>"
                                                        ...
                                                        <div class="col-md-4 quantity">
                                                            <label
                                                                for="quantity_<?php echo $index; ?>">Quantity:</label>
                                                            <input id="quantity_<?php echo $index; ?>" type="number"
                                                                value="<?php echo $item['quantity']; ?>"
                                                                class="form-control quantity-input"
                                                                onchange="updatePrice(<?php echo $index; ?>)">
                                                        </div>
                                                        <div class="col-md-3 price">
                                                            <span
                                                                id="price_<?php echo $index; ?>">£<?php echo number_format($item['price'] * $item['quantity'], 2); ?></span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-1">
                                                <form method="post"
                                                    ...
                                                    <button type="submit" class="btn btn-link btn-sm"
                                                        style="color: gray; font-size: 30px;">&times;</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12 col-lg-4">
                                <div class="summary">
                                    <h3>Summary</h3>
                                    <div class="summary-item"><span class="text">Subtotal</span><span class="text">
                                        </span><span id="subtotal">£0.00</span></div>
        ...
        ?>
            ...
            var quantity_<?php echo $index; ?> = parseInt(document.getElementById('quantity_<?php echo $index; ?>')
                .value);
