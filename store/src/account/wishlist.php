...
<body class="overflow-x-hidden flex flex-col min-h-screen">
    ...
    <section class="my-8 mx-auto max-w-7xl">
        <h1 class="text-3xl font-bold text-center my-6">Your wish list</h1>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4">
            <!-- Wishlist items here... -->
            <div class="bg-white shadow rounded overflow-hidden">
                <img src="blackcatsneaker 1.png" alt="Wales Bonner x adidas Samba Pony 'Black'" class="w-full" />
                <div class="p-4">
                    <h2 class="font-bold text-lg">Wales Bonner x adidas Samba Pony 'Black'</h2>
                    <p class="text-gray-700">UK 7.5</p>
                    <p class="text-gray-900">£185.00</p>
                    <button class="mt-3 w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                        ADD TO CART
                    </button>
                </div>
            </div>
        ...
        <div class="text-center">
            <button class="mt-6 bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white py-2 px-4 border border-red-500 hover:border-transparent rounded">
                Clear all
            </button>
        </div>
    </section>
