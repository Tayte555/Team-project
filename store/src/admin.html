...
<div class="flex h-screen overflow-hidden">
  ...
  <!-- Sidebar -->
  <div id="sidebar" class="bg-blue-700 text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full transition duration-200 ease-in-out">
    <nav>
      <a href="#" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-800 hover:text-white">Dashboard</a>
      <a href="home.php" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-blue-800 hover:text-white">Logout</a>
      <!-- More nav items -->
    </nav>
  </div>
  ...
  <div class="flex-1 flex flex-col overflow-hidden content">
    ...
    <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200 p-10">
      <div class="flex space-x-4 mb-8">
        <div class="flex-1 bg-white p-6 rounded-lg shadow-lg text-center cursor-pointer tab-button" data-tab="orders">
          <div class="text-green-500 text-2xl mb-2">•</div>
          <h2 class="text-gray-700 text-lg mb-1">Orders</h2>
          
        </div>
        <div class="flex-1 bg-white p-6 rounded-lg shadow-lg text-center cursor-pointer tab-button" data-tab="inventory">
            <div class="text-red-500 text-2xl mb-2">•</div>
            <h2 class="text-gray-700 text-lg mb-1">Inventory</h2>
            
          </div>
        <div class="flex-1 bg-white p-6 rounded-lg shadow-lg text-center cursor-pointer tab-button" data-tab="shipped">
          <div class="text-blue-500 text-2xl mb-2">•</div>
          <h2 class="text-gray-700 text-lg mb-1">Shipped</h2>
          
        </div>
        <div class="flex-1 bg-white p-6 rounded-lg shadow-lg text-center cursor-pointer tab-button" data-tab="pending">
          <div class="text-yellow-500 text-2xl mb-2">•</div>
          <h2 class="text-gray-700 text-lg mb-1">Pending</h2>
        
        </div>
        <div class="flex-1 bg-white p-6 rounded-lg shadow-lg text-center cursor-pointer tab-button" data-tab="users">
            <div class="text-purple-500 text-2xl mb-2">•</div>
            <h2 class="text-gray-700 text-lg mb-1">Users</h2>
            
          </div>
        <div class="flex-1 bg-white p-6 rounded-lg shadow-lg text-center cursor-pointer tab-button" data-tab="add-product">
          <div class="text-yellow-500 text-2xl mb-2">+</div>
